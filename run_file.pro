...
in_path              = '/vol/v1/general_files/user_files/justin/ee_lt_idl_label_test/'
out_path             = in_path+'label/'
min_year             = 1984
max_year             = 2016

static_model         = "no_cover_model_nbr" ;if no cover model, this needs to adjust for dist up or down
...
merge_recovery       = 1 ; "yes" or "no"
extract_tc_ftv       = 1  ; "yes" or "no"
use_relative_mag     = 0  ; "yes" or "no"
end_year             = -1
start_year           = -1
